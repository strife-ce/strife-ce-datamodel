export enum EC2ServerMessage {
  ...
  CHAT_UPDATE_STATE = 'C2S_CHAT_UPDATE_STATE',
  PARTY_CANCEL_MATCHMAKING = 'C2S_PARTY_CANCEL_MATCHMAKING',
  PARTY_CREATE = 'C2S_PARTY_CREATE',
  PARTY_CREATE_AND_READY = 'C2S_PARTY_CREATE_AND_READY',
  PARTY_INVITE = 'C2S_PARTY_INVITE',
  PARTY_INVITE_ACCEPT = 'C2S_PARTY_INVITE_ACCEPT',
  PARTY_INVITE_DECLINE = 'C2S_PARTY_INVITE_DECLINE',
  PARTY_REMOVE_MEMBER = 'C2S_PARTY_REMOVE_MEMBER',
...
export enum ES2ClientMessage {
  ...
  CHAT_ACCOUNTLIST = 'S2C_CHAT_ACCOUNTLIST',
  CHAT_UPDATE_ACCOUNT = 'S2C_CHAT_UPDATE_ACCOUNT',
  QUEUE_STATES_UPDATE = 'S2C_QUEUE_STATES_UPDATE',
  PARTY_CREATED = 'S2C_PARTY_CREATED',
  PARTY_INVITED = 'S2C_PARTY_INVITED',
  PARTY_INVITE_CANCELED = 'C2S_PARTY_INVITE_CANCELED',
  PARTY_UPDATED = 'S2C_PARTY_UPDATED',
  PARTY_STARTED_MATCHMAKING = 'S2C_PARTY_STARTED_MATCHMAKING',
  PARTY_CANCELED_MATCHMAKING = 'S2C_PARTY_CANCELED_MATCHMAKING',
  MATCH_PREPARING = 'S2C_MATCH_PREPARING',
  MATCH_READY = 'S2C_MATCH_READY',
  MATCH_FINISHED = 'S2C_MATCH_FINISHED',
}

export enum EG2ServerMessage {
  REGISTER = 'G2S_REGISTER',
  MATCH_CREATED = 'G2S_MATCH_CREATED',
  MATCH_FINISHED = 'G2S_MATCH_FINISHED',
}
